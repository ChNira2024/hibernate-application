...
public class OneToManyDAOImpl implements OneToManyDAO {
	...
	public void saveDataUsingParent() {
		//get Session
				...
				//prepare objects
				  //child objs
				PhoneNumber ph1=new PhoneNumber(5999999L,"residence","airtel");
				PhoneNumber ph2=new PhoneNumber(58888888L,"officeeeeeeeeeeeeee","vi");
				Set<PhoneNumber> phonesSet=Set.of(ph1, ph2);
				  //parent obj
				 UserInfo user=new UserInfo("raja","hyd");
