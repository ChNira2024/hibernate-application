	...
	public static void main(String[] args) {
	    ...
	    account=ses.get(BankAccount.class,101L);
	     if(account!=null) {
			...
			System.out.println("modify 101 record in DB table  from SQL prompt/developer");
			try {
...
//The session.refresh(entityObject) method in Hibernate is used to re-fetch the state of a persistent entity from the databa